...
export default class EditProperty extends Component {
	...
	render() {
		...
		return (
			<div>
				<Button onClick={this.toggle}>Edit Property</Button>
				<Modal
					isOpen={this.state.modal}
					toggle={this.toggle}
					className={this.props.className}
				>
					<ModalHeader toggle={this.toggle}>Edit Property Details</ModalHeader>
					<ModalBody>
						<Form>
							<FormGroup row>
							...
							<Button color="primary" onClick={this.submitEditProperty}>
								Edit Property
							</Button>
						</Form>
					</ModalBody>
